...
var $author$project$Main$llmResponseDecoder = A3(
	...
	$elm$json$Json$Decode$succeed($author$project$Main$LLMResponse));
		...
		switch (msg.$) {
			...
			case 'UseResponseToUpdateModel':
				...
				switch (webDataResponse.$) {
					case 'Success':
						var new_llmResponse = webDataResponse.a;
			...
			default:
				var index = msg.a;
				var tableRows = _Utils_ap(
					A2($elm$core$List$take, index, model.tableRows),
					A2($elm$core$List$drop, index + 1, model.tableRows));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{tableRows: tableRows}),
...
var $author$project$Main$UpdateRequest = function (a) {
									...
									[
										...
										_List_fromArray(
											[
												...
												$author$project$Main$DeleteRow(index))
											]),
										_List_fromArray(
											[
...
var $author$project$Main$viewTableRows = function (tableRows) {
	return A2($elm$core$List$indexedMap, $author$project$Main$viewTableRow, tableRows);
};
			...
			case 'BadStatus':
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Bad Status: ' + $elm$core$String$fromInt(_int))
						]));
			default:
				var string = error.a;
				return A2(
	...
	switch (state.$) {
		case 'NotAsked':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Try a search'),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$SendRequest(model.input))
							]),
						_List_fromArray(
							[
		...
		case 'Failure':
			...
			return A2(
				...
				_List_fromArray(
					[
						A2($author$project$Main$decodeError, model, err),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
